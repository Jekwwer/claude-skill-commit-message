...
```bash
claude plugin marketplace add Jekwwer/claude-skill-commit-message
claude plugin install claude-skill-commit-message@claude-skill-commit-message
```
...
```bash
claude plugin remove claude-skill-commit-message@claude-skill-commit-message
```
